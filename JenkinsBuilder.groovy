            ...
            container('docker') {
                withCredentials([usernamePassword(credentialsId: 'docker-creds', passwordVariable: 'PASSWORD', usernameVariable: 'USERNAME')]) {
                    ...
                    stage('Docker Push') {
                        ...
                        sh "docker tag artemis akynbek/artemis:${gitCommitHash}"
                        sh "docker push akynbek/artemis:${gitCommitHash}"
                    }
                    stage('Trigger Deploy') {
                      ...
                      parameters: [
                        ...
                        string(name: 'selectedDockerImage', value: "akynbek/artemis:${gitCommitHash}"), 
